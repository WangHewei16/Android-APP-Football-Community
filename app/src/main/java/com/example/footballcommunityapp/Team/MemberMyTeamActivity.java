...
public class MemberMyTeamActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_member_my_team);
        this.getWindow().setBackgroundDrawableResource(R.drawable.myteaminnerbackground);
        TextView announcementTextView=(TextView)this.findViewById(R.id.editTextTextPersonName8);
        UserService uService = new UserService(MemberMyTeamActivity.this);
        announcementTextView.setText(uService.giveAnnouncement());
        System.out.println("++++++++++++++"+uService.giveAnnouncement());
        System.out.println("++++++++++++++"+uService.getTeamIDAnotherWay());
...
//                                p.setColor(bitmap.getColor(10,10).toArgb());
        ...
        // quit the team
        android.widget.Button quitButton=(Button)this.findViewById(R.id.button15);
        View.OnClickListener quitClick= new View.OnClickListener() {
            public void onClick(View v){
                AlertDialog.Builder builder = new Builder(MemberMyTeamActivity.this);
                builder.setIcon(R.drawable.newicon);//设置图标, 这里设为空值
                builder.setTitle("Quit Team");
                ...
                builder.setPositiveButton("Confirm", new OnClickListener(){
                    public void onClick(DialogInterface arg0, int arg1){
                        UserService uService = new UserService(MemberMyTeamActivity.this);
                        uService.quitTeam();
                        Intent in = new Intent(tem, MenusActivity.class);
                        tem.startActivity(in);
                        Toast.makeText(MemberMyTeamActivity.this,"Confirm succeeded",Toast.LENGTH_SHORT).show();
                    }
                });

                builder.setNegativeButton("Cancel", new OnClickListener(){
                    public void onClick(DialogInterface arg0, int arg1){
                        Toast.makeText(MemberMyTeamActivity.this, "Cancel succeeded", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        quitButton.setOnClickListener(quitClick);
